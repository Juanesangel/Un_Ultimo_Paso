		...
		namespace iOS
		{
			...
			typedef AKRESULT ( * AudioInputCallbackFunc )(
				const AudioBufferList* io_Data,	///< An exposed CoreAudio structure that holds the input audio samples generated from 
											...
											///< size can be obtained from the structure. See the microphone demo of the IntegrationDemo for an example of usage.
...
struct AkPlatformInitSettings
{
	...
	AkThreadProperties  threadOutputMgr;		///< Output thread threading properties
